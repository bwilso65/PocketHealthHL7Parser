...
public enum AckCode
{
    /// <summary>Application Accept — stored and processed.</summary>
    AA,
...
/// <summary>
/// Why a message was not accepted. <see cref="Code"/> is our own stable vocabulary (stored in the DB, useful for
/// dashboards); <see cref="Hl7ErrorCode"/> is the HL7 table-0357 code carried back to the sender in ERR-3.
/// </summary>
